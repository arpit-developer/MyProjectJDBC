...
<div class="card bg-light mb-4" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><a href="./homepage">Click to Create new User</a></p>
  </div>
</div>
<div class="card text-white bg-secondary mb-4" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><a href="./userlist">Click to Display All user</a></p>
  </div>
</div>
<div class="card text-white bg-success mb-4" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><a href="./">Click to Edit User</a></p>
  </div>
</div>
</div>
<div class="card-deck">
<div class="card text-white bg-danger mb-4" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><a href="./">Click to Delete User</a></p>
  </div>
</div>
<div class="card text-white bg-warning mb-4" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><a href="https://github.com/arpit-developer">Click</a></p>
  </div>
</div>
<div class="card text-white bg-primary mb-4" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><a href="https://www.linkedin.com/in/arpit-bhatnagar17/">Click</a></p>
  </div>
</div>
</div>
<div class="card-deck">
